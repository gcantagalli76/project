  ...
  <div class="container-fluid centerPage text-center">
    ...
    <form class="col-sm-3" method="post">
        <a href="mespublications.php">
          <button type="button" class="btn btn-primary btn-lg" name="myPublications">Mes publications <br> <i class="bi bi-newspaper"></i>
          </button>
        </a>
          </form>
      ...
      <form class="col-sm-3" method="post">
        <button type="submit" class="btn btn-primary btn-lg" id="disconnect" name="disconnect">Se deconnecter <br> <i
